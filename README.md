...
| Занятие 6 | 10.11.2025 | Модели МО различной архитектуры. Искуственная нейронная сеть. Непараметрические модели. Метод K ближайших соседей. | [Ноутбук (сравнение моделей, синтетические данные)](https://github.com/mvarentsov/ML4hydromet-2025/blob/main/examples/Lect06a_model_comparison_synthetic_data.ipynb)<br/>[Ноутбук (сравнение моделей, реальные данные)](https://github.com/mvarentsov/ML4hydromet-2025/blob/main/examples/Lect06b_model_comparison_real_data.ipynb)|
